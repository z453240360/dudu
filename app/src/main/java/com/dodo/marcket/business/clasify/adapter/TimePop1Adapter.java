...
public class TimePop1Adapter extends RecyclerView.Adapter<TimePop1Adapter.MyViewHolder> {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<SelectPostTimeBean> mDatas = new ArrayList<>();

    public TimePop1Adapter(Context context, List<SelectPostTimeBean> datas) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener!=null){
                    mListener.onItemClick(position,mDatas.get(position).getSelectDay());
                }
            }
        });
        holder.mTxtDesc.setText(mDatas.get(position).getSelectDay());
