...
public class PayPopAdapter extends RecyclerView.Adapter<PayPopAdapter.MyViewHolder> {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<PayMethodBean> mDatas = new ArrayList<>();

    public PayPopAdapter(Context context, List<PayMethodBean> datas) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.adapter_paypop, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final PayMethodBean payMethodBean = mDatas.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mListener!=null){
                    mListener.onItemClick(position,payMethodBean.getId());
                }
            }
        });
        if (selected){
