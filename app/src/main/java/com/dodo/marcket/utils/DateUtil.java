...
public class DateUtil {
    ...
    public static final SimpleDateFormat YEAR_MONTH_DAY2 = new SimpleDateFormat("yyyy-MM");
    public static final SimpleDateFormat YEAR_MONTH_DAY3 = new SimpleDateFormat("yyyy年MM月");
     ...
     * @return 时间字符串
     */
    public static String milliseconds2StringYeaerM(long milliseconds) {
        return milliseconds2String(milliseconds, YEAR_MONTH_DAY2);
    }

    public static String milliseconds2StringYeaerM2(long milliseconds) {
        return milliseconds2String(milliseconds, YEAR_MONTH_DAY3);
    }
