...
public class ImageLoaders {
    ...
    public static final int errorImgId= R.mipmap.no_date;
    public static final int cameraImgId=R.mipmap.ic_launcher;
     ...
     * @param url
     */
    public static void displayConnerImg(ImageView imageView, String url,int radius) {
        //设置图片圆角角度
